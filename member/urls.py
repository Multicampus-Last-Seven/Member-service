...
urlpatterns = [
    ...
    path('serials', views.iots_list, name='serials'),
    ...
    path('<str:userid>/iots', views.iot_view, name='serial_view'),
    path('<str:serialid>', views.iot_alive_view, name='serial_alive_view')  
]
